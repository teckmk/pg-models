...
* [PgormModel](#PgormModel)
    * [new PgormModel(modalName, options)](#new_PgormModel_new)
    * _instance_
        * [.tableName](#PgormModel+tableName)
        * [.define(columns, options)](#PgormModel+define)
        * [.findAll(options)](#PgormModel+findAll) ⇒
        * [.findAllWhere(whereClause, paramsArray)](#PgormModel+findAllWhere) ⇒
        * [.findOne(column, value)](#PgormModel+findOne) ⇒
        * [.findById(id)](#PgormModel+findById) ⇒
        * [.updateById(id, values)](#PgormModel+updateById) ⇒
        * [.create(values)](#PgormModel+create) ⇒
        * [.deleteById(id)](#PgormModel+deleteById) ⇒
        * [.beforeCreate(fn)](#PgormModel+beforeCreate)
        * [.beforeUpdate(fn)](#PgormModel+beforeUpdate)
        * [.beforeDestroy(fn)](#PgormModel+beforeDestroy)
        * [.addQueryMethod(methodName, fn)](#PgormModel+addQueryMethod)
        * [.addForeignKey(fkName, parentTableName)](#PgormModel+addForeignKey)
    * _static_
        * [.useConnection(dbConnection)](#PgormModel.useConnection)
        * [.setOptions(options)](#PgormModel.setOptions)
...
| Param | Type | Description |
| --- | --- | --- |
| dbConnection | <code>PG\_Client</code> | The pg client object returned by `pg.connect()` |
